...
//  BetterRest
//
//  Created by PRABALJIT WALIA     on 28/08/20.
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        NavigationView{
            Form{
                Section(header:Text("When do you want to wake up?").font(.headline).bold().foregroundColor(.black)){
            ...
            .navigationBarItems(trailing:
                ...
                .alert(isPresented: $showingAlert){
                    Alert(title: Text(alertTitle), message: Text(alertMsg).font(.largeTitle), dismissButton: .default(Text("Ok")))
            }
        }
